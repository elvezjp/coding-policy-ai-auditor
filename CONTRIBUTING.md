...
When contributing:
- Work on the latest code at the repository root (`backend/` / `frontend/`); old versions are frozen snapshots preserved under the `v0.5.1` tag and are not maintained
