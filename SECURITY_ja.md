...
2. [GitHub の非公開脆弱性報告](https://github.com/elvezjp/coding-policy-ai-auditor/security/advisories/new)を利用してください。
...
- Excel アップロードの拡張子検証（API ではアップロードされた MIME タイプは検証しません）
- ファイルサイズの制限
- 入力ファイルの検証
