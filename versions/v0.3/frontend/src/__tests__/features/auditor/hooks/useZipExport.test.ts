...
import { useZipExport } from '@features/auditor/hooks/useZipExport'
...
describe('useZipExport', () => {
  ...
  describe('downloadRuleMarkdown', () => {
    it('規約マークダウンをダウンロードできる', () => {
      const { result } = renderHook(() => useZipExport())

      result.current.downloadRuleMarkdown('# Rule Markdown')
